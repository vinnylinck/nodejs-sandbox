...
class SandApp {
  ...
  async Run(port, secOpts, tmpOpts) {
    // db connection / init
    ...
    this.app.get('/tools/hello', this.#ensureAuth, routes.ToolsHello);
    this.app.get('/tools/lists', this.#ensureAuth, CheckScopes(scopes.LIST_READ, scopes.ITEM_READ), routes.ToolsListMgr);
